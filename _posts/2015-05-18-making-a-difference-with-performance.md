...
**EDIT**: I had a [chat with Anselm Hannemann](https://twitter.com/helloanselm/status/601280994877042688) about this so I want to this decision further. I didn't go no jQuery because somebody like Lea Verou said so, I did it because vanilla JavaScript is much faster and it avoided loading the entire jQuery library. But getting good browser support (even with latest versions of Chrome and Firefox) is way more complex that it may seem. Being aware of these issues is a vital part of going no jQuery. Resources like [Remy Sharp's polyfill collection](https://github.com/remy/polyfills) or [Polyfill.io from FT labs](https://cdn.polyfill.io/v1/docs/) will help you get a broader support of browsers, but you still need to know what you are doing, and all the [bugfixes that jQUery does for you](https://docs.google.com/document/d/1LPaPA30bLUB_publLIMF0RlhdnPx_ePXm7oW02iiT6o/preview). Even with all those concerns, I believe that most presentation websites could go no jQuery if they don't have to support IE8 and lower.
