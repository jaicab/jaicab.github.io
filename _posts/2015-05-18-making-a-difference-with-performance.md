...
**EDIT**: I had a [chat with Anselm Hannemann](https://twitter.com/helloanselm/status/601280994877042688) because I wasn't reflecting what took parth in this decision and it may have been seen as I was simply following the _no jQuery trend_. I didn't go no jQuery because somebody like Lea Verou said so, I did it because vanilla JavaScript is much faster and it avoided loading the library. But getting good browser support (even with latest versions of Chrome and Firefox) is way more difficult that it seems. Being aware of these issues is a vital part of going no jQuery. 
